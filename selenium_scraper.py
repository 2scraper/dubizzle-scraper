...
def parse_args():
    p = argparse.ArgumentParser(
        description="dubizzle auction scraper (Selenium edition). Cannot authenticate a "
                    "proxy or a remote CDP endpoint — see the module "
                    "docstring; playwright_scraper.py is the primary engine.")
    p.add_argument("--url", default=None,
                   help="A dubizzle URL: /{loc}/c/{id}-{slug}, /{loc}/s?q=..., "
                        "/p/<cat>/<sub>/<subsub>, or /{shop}/{slug} with "
                        "--mode product. Required, unless DUBIZZLE_URL is "
