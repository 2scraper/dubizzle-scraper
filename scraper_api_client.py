#!/usr/bin/env python3
"""dubizzle-scraper — 2captcha Scraper API edition (fourth engine)
...
def parse_args():
    ...
    p.add_argument("--out", default="dubizzle_products_scraperapi", help="Output file prefix")
