...
**"dubizzle-scraper security"** in the subject — otherwise it lands in a queue
...
- **Bypassing dubizzle's bot protection.** This scraper drives an ordinary
  browser and passes challenges the way a browser does. Anything about how
  Imperva or reCAPTCHA behave is not a vulnerability in this repository.
- **The scraper stopped working.** dubizzle changing its markup is expected —
